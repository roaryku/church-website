...
function MembersInfoUpdate () {
    ...
    return(
        ...
        <div className='InfoUpdateContainer'>
            <h2 className='headerAbout'>{t ('Member Contact Information Update')}</h2>
            <p className='membersInfo'>{t ('Members info update')}</p>
        ...
        <Form.Label className="mb-3" controlId="exampleForm.ControlLastName">{t ('Last name')}</Form.Label>
         ...
         <Form.Group className="mb-4" controlId="exampleForm.ControlInput1">
            <Form.Label>{t ('Home Phone Number')}</Form.Label>
            <Form.Control 
            type="numbers" 
        ...
        <Form.Group className="mb-4" controlId="exampleForm.ControlInput1">
            <Form.Label>{t ('Cell Phone Number')}</Form.Label>
            <Form.Control 
            type="numbers" 
...
export default MembersInfoUpdate;